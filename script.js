(function () {
  ...
  function applyLang(lang) {
    ...
    try { localStorage.setItem("mariano-lang", lang); } catch (e) {}
  }
  document.querySelectorAll(".lang button").forEach(function (btn) {
    btn.addEventListener("click", function () { applyLang(btn.getAttribute("data-set")); });
  });
  var saved = null;
  try { saved = localStorage.getItem("mariano-lang"); } catch (e) {}
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      var body = "Mariano Electric service call\nName: " + name + "\nAddress: " + address + "\nNeed: " + need;
